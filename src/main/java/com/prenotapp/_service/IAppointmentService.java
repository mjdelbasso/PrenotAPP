...
public interface IAppointmentService extends ICRUD<Appointment, Integer> {
    ...
    public AppointmentDetailsDTO findAppointmentById(Integer idAppointment) throws Exception;

    public boolean AppointmentAlredyExist(Appointment appointment) throws Exception;
